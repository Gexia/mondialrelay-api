...
public class WebServices extends Service {
	...
	/**
	 * 
	 * @return returns WebServicesSoap
	 */
	@WebEndpoint(name = "Web_ServicesSoap")
	public WebServicesSoap getWebServicesSoap() {
		return super.getPort(new QName("http://www.mondialrelay.fr/webservice/", "Web_ServicesSoap"),
				WebServicesSoap.class);
	}
	...
	public WebServicesSoap getWebServicesSoap(WebServiceFeature... features) {
		return super.getPort(new QName("http://www.mondialrelay.fr/webservice/", "Web_ServicesSoap"),
				WebServicesSoap.class, features);
	}
