...
/**
 * <p>
 * Classe Java pour PointRelais_Details complex type.
 * 
 * <p>
...
@XmlType(name = "PointRelais_Details", propOrder = { "stat", "num", "lgAdr1", "lgAdr2", "lgAdr3", "lgAdr4", "cp",
		"ville", "pays", "localisation1", "localisation2", "latitude", "longitude", "typeActivite", "nace",
		"information", "horairesLundi", "horairesMardi", "horairesMercredi", "horairesJeudi", "horairesVendredi",
		"horairesSamedi", "horairesDimanche", "informationsDispo", "urlPhoto", "urlPlan", "distance" })
public class PointRelaisDetails {
	 ...
	 * 
	 * @return possible object is {@link ArrayOfPeriode }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link ArrayOfPeriode }
	 * 
	 */
