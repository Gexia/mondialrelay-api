...
/**
 * <p>
 * Classe Java pour ret_WSI2_RecherchePointRelais complex type.
 * 
 * <p>
...
@XmlType(name = "ret_WSI2_RecherchePointRelais", propOrder = { "pr01", "pr02", "pr03", "pr04", "pr05", "pr06", "pr07",
		"pr08", "pr09", "pr10" })
public class RetWSI2RecherchePointRelais extends Ret {
	 ...
	 * 
	 * @return possible object is {@link RetWSI2SubPointRelais }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link RetWSI2SubPointRelais }
	 * 
	 */
